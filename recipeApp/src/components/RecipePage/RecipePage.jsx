...
function RecipePage(){
  ...
  <div className="m-8 max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
    ...
    <div className="mt-4 col-start-1 row-start-3 self-center sm:mt-0 sm:col-start-2 sm:row-start-2 sm:row-span-2 lg:mt-6 lg:col-start-1 lg:row-start-3 lg:row-end-4">
      <button type="button" className="w-full h-8 mt-4 rounded-sm  px-2.5 py-1 text-[10px] font-semibold text-white shadow-sm hover:bg-black/80 bg-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">Recipe Video</button>
    </div>
